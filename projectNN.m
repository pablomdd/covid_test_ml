...
Test17 = [Ch_p0, Di_b0, Fe2, D_co2, Bl_lf1, Tir4 ...
...
Test24 = [Ch_p1, Di_b1, Fe2, D_co2, Bl_lf2, Tir1 ...
...
Test29 = [Ch_p0, Di_b0, Fe3, D_co1, Bl_lf0, Tir4 ...
...
%% Training
[W11, W12, b11, b12] = training(0.00001, 90, num_test, P, W1, W2, b1, b2, t, F);
[W21, W22, b21, b22] = training(0.00001, 1000, num_test, P, W1, W2, b1, b2, t, F);
[W31, W32, b31, b32] = training(0.00001, 23000, num_test, P, W1, W2, b1, b2, t, F);
[W41, W42, b41, b42] = training(0.00001, 2500, num_test, P, W1, W2, b1, b2, t, F);
[W51, W52, b51, b52] = training(0.00001, 800, num_test, P, W1, W2, b1, b2, t, F);
[W61, W62, b61, b62] = training(0.00001, 250, num_test, P, W1, W2, b1, b2, t, F);
[W71, W72, b71, b72] = training(0.00001, 500, num_test, P, W1, W2, b1, b2, t, F);
[W81, W82, b81, b82] = training(0.00001, 210, num_test, P, W1, W2, b1, b2, t, F);
...
%  b2x = -3.0717 ;
% 
Testx = [Ch_p4, Di_b4, Fe5, D_co2, Bl_lf0, Tir4 ...
         L_ts2, M_a5, S_t2, Cong4, Hea2, Chi3 ...
         Rash2, N_V1, D0];%Test to train 
     
% Testy = [Ch_p2, Di_b3, Fe4, D_co3, Bl_lf2, Tir4 ...
%          L_ts4, M_a2, S_t3, Cong1, Hea4, Chi2 ...
%          Rash3, N_V2, D2];%Test to train 
% 
Testz = [Ch_p0 Di_b0, Fe4, D_co0, Bl_lf1, Tir4 ...
